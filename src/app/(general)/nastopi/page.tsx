    ...
    <main>
      ...
      <section className="text-neutral-900 pb-2 flex space-x-4 items-start md:items-center md:px-4 px-2 text-sm md:text-base">
        ...
        <div>
          ...
          <p>Režija: Cvetka Bevc</p>
          <p>Uglasbene pesmi: Peter Andrej</p>
          <p>Lastna produkcija Cezama, društva Glazerjeva domačija in Kluba KU KU v sodelovanju z JSKD</p>
        </div>
      </section>
      ...
      <section className="text-neutral-900 pb-2 flex space-x-4 items-start md:items-center md:px-4 px-2 text-sm md:text-base">
        ...
        <div>
          ...
          <p>Napisal: Peter Andrej</p>
          <p>Ilustrirala: Kaja Lukač</p>
          <p>Za kamišibaj priredila in ga izvedla: Mojca Andrej</p>
          <p>Pojeta: Peter Andrej in Barbara Gabrielle</p>
        </div>
      </section>
      ...
      <section className="text-neutral-900 pb-2 flex space-x-4 items-start md:items-center md:px-4 px-2 text-sm md:text-base">
        ...
        <div>
          ...
          <p>Napisala: Mojca Andrej</p>
          <p>Ilustrirala: Darka Erdelji</p>
          <p>Pesmi napisal, uglasbil in zapel: Peter Andrej</p>
          <p>Za kamišibaj priredila in ga izvedla: Mojca Andrej</p>
        </div>
      </section>
      ...
      <section className="text-neutral-900 pb-2 flex space-x-4 items-start md:items-center md:px-4 px-2 text-sm md:text-base">
        ...
        <div>
          ...
          <p>Povabilo mag. Susanne Weitlaner (Kulturno društvo Člen 7 za avstrijsko Štajersko) in Tatjane Vučajnk, predstava za otroke, ki govorijo in se učijo slovenščino.</p>
          <p>Prenovljeno podobo Agice, male čarovnice sta sooblikovala Darka Erdelji (oblikovanje lutk in likovna podoba) in Urban Saletinger (izdelava scene).</p>
          <p>12. Glazerjevi dnevi: muzikal za otroke, <em className="font-semibold">Agica mala čarovnica</em>; Gostitelj: Zavod RAST Ruše, Občina Ruše, december 2022</p>
          <p>Nastopali: Mojca Andrej, Peter Andrej in Alenka Cilenšek</p>
        </div>
      </section>
      ...
      <section className="text-neutral-900 pb-2 flex space-x-4 items-start md:items-center md:px-4 px-2 text-sm md:text-base">
        ...
        <div>
          ...
          <p>Predstavitev poezije za otroke <em className="font-semibold">Rastem do tebe</em>, september 2015. Organizator: Kulturno – gledališko društvo Reciklaža, Slovenske Gorice.</p>
        </div>
      </section>
      ...
      <section className="text-neutral-900 pb-2 flex space-x-4 items-start md:items-center md:px-4 px-2 text-sm md:text-base">
        ...
        <div>
          ...
          <p>Predstavitev pesniške zbirke <em className="font-semibold">Ostanek umrle zvezde</em>; Slovenski dnevi knjige v Mariboru, Minoriti, 20. junij 2021. Literarno branje Literinih avtorjev in avtorice. Nastopili so Vasja Jager, Mojca Andrej, Bojan Sedmak in Tomo Podstenšek. Povezoval je Orlando Uršič. Prireditev je organiziral MKC Maribor v sodelovanju z Založbo Litera. Izvedba: MKC Maribor in KGB v sodelovanju z LGM.</p>
        </div>
      </section>
      ...
      <section className="text-neutral-900 pb-2 flex space-x-4 items-start md:items-center md:px-4 px-2 text-sm md:text-base">
        ...
        <div>
          ...
          <p>Prva predstavitev romana <em className="font-semibold">Kavč učiteljice Veronike</em>; na OŠ Prežihovega Voranca Maribor v soorganizaciji založbe Litera in šole, 29. november 2022. Z avtorico se je pogovarjala urednica založbe Gabriela Babnik Ouattara.</p>
        </div>
      </section>
      ...
      <section className="text-neutral-900 pb-2 flex space-x-4 items-start md:items-center md:px-4 px-2 text-sm md:text-base">
        ...
        <div>
          ...
          <p>Predstavitev romana <em className="font-semibold">Kavč učiteljice Veronike</em>; Antika knjigarna Celje, 7. 11. 2023. Nekatere Veronikine pesmi iz <em className="font-semibold">Blagajne misli</em> je odigral Peter Andrej. Z avtorico se je pogovarjal Matej Krajnc.</p>
          <p>Center za poezijo Tomaža Šalamuna, Ljubljana; 9. 11. 2023. Avtorico romana <em className="font-semibold">Kavč učiteljice Veronike</em> je poglobljeno predstavila Barbara Rigler. Tatjana Vidmar in avtorica sta prebrali odlomke iz knjige. Nekatere Veronikine pesmi iz <em className="font-semibold">Blagajne misli</em> je odigral Peter Andrej.</p>
          <p>13. Glazerjevi dnevi na gostovanju, 15. 11. 2023, v Literarni hiši Maribor: promocija knjige Mojca Andrej, <em className="font-semibold">Kavč učiteljice Veronike</em>. Nekatere Veronikine pesmi iz <em className="font-semibold">Blagajne misli</em> je odigral Peter Andrej. Z avtorico se je pogovarjal Marjan Pungartnik.</p>
        </div>
      </section>
      ...
      <h4 className="md:text-base text-sm pl-1 pb-2 text-neutral-500">Hrvaška, Bosna in Hercegovina, Srbija, Severna Makedonija, Bolgarija, Avstrija, Palma de Mallorca, Maroko.</h4>
      ...
      <section className="text-neutral-900 pb-2 flex space-x-4 items-start md:items-center md:px-4 px-2 text-sm md:text-base">
        ...
        <div>
          <p>Poetski festival Neretvanske vedrine; Počitelj, Mostar, Sarajevo, BIH. Literarna branja</p>
        </div>
      </section>
      ...
      <section className="text-neutral-900 pb-2 flex space-x-4 items-start md:items-center md:px-4 px-2 text-sm md:text-base">
        ...
        <div>
          ...
          <p>Branje poezije v Beogradu, v Matici iseljenika Srbije, 16. 11. 2017. Nastop s Petrom Andrejem, Jernejem Mažgonom in Grgo Olahom iz Madžarske. Gostitelj Kuča Arte, Miodrag Jakšić.</p>
          <p>Glazerjevi dnevi v Pančevu, Narodni muzej Pančevo, Društvo Slovencev južnega Banata Logarska dolina, gostitelj Josip Weber, 17. 11. 2017</p>
          <p>44. Karamanova srečanja, Severna Makedonija, Radoviš, 1. in 2. 12. 2017, branje poezije, tudi program za otroke.</p>
        </div>
      </section>
      ...
      <section className="text-neutral-900 pb-2 flex space-x-4 items-start md:items-center md:px-4 px-2 text-sm md:text-base">
        ...
        <div>
          ...
          <p>100 Илјади поети за промена, Struška srečanja; Strumica, Severna Makedonija; literarni nastopi, september 2019.</p>
        </div>
      </section>
      ...
      <section className="text-neutral-900 pb-2 flex space-x-4 items-start md:items-center md:px-4 px-2 text-sm md:text-base">
        ...
        <div>
          ...
          <p>Takt festival; Novi Sad: 20. KANTFEST je svoj International nadaljeval v Novem Sadu. Nastop: Bojan Sedmak, Mojca Andrej, Neaboinula (Bojan Tomažič) in Peter Andrej.</p>
        </div>
      </section>
