...
export default function Objave() {
    return (
        <main>
            <h1 className="text-2xl w-fit bg-gradient-to-r bg-clip-text text-transparent from-yellow-500 to-amber-500 font-semibold mb-4">Objave</h1>
  ...
  {objave.map((objava, index) => (
    ...
    >
      ...
      <p className="absolute top-3 right-3 text-gray-500 text-xs">{objava.datum}</p>
